...
namespace InstantBuild
{
    ...
    public class InstantBuildAndView : EditorWindow
    {
        ...
        private static void StartInstantBuild(string targetAssetPath, BuildTarget buildTarget)
        {
            ...
            BuildPipeline.BuildAssetBundles(dirPath, buildMap, BuildAssetBundleOptions.ForceRebuildAssetBundle, buildTarget);
            ...
            for (;;)
            {
                ...
                if (isTargetRange)
                {
                    if (line == "Bundle Name: " + buildMap[0].assetBundleName.ToLower())
                        bundleInfo = true;
