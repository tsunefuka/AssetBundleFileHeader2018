...
namespace InstantBuild
{
    public class InstantBuildInfo
    {
        ...
        public InstantBuildInfo(string log)
        {
            ...
            // ピックアップしたい要素
            var picks = new string[] { "Textures", "Meshes", "Animations", "Sounds", "Shaders", "Other Assets", "Levels", "Scripts", "Included DLLs", "File headers" };
            ...
            foreach (var line in lines)
            {
                ...
                if (!inSummary && line.Contains("Bundle Name: instantassetbundle.unity3d"))
                {
                    inSummary = true;
                    continue;
                }
